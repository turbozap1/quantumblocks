...
<title>
  QuantumBlocks | Login
</title><link rel="stylesheet" type="text/css" href="/CSS/AllCSS.css"><link id="_ctl0_Imports" rel="stylesheet" type="text/css" href="/CSS/AllCSS.css"><link id="_ctl0_Favicon" rel="Shortcut Icon" type="image/ico" href="/"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="author" content="ROBLOX Corporation"><meta name="description" content="ROBLOX is SAFE for kids! ROBLOX is a FREE casual virtual world with fully constructible/desctructible environments and immersive physics. Build, battle, chat, or just hang out."><meta name="keywords" content="game, video game, building game, contstruction game, online game, LEGO game, LEGO, MMO, MMORPG, virtual world, avatar chat"><meta name="robots" content="all">
...
<script type="text/javascript"></script>
  ...
  <div id="FrameLogin" style="margin: 150px auto 150px auto; width: 500px; border: black thin solid; padding: 22px;">
    <div id="PaneNewUser">
      <h3>New User?</h3>
      <p>You need an account to play QuantumBlocks.</p>
      <p>If you aren't a QuantumBlocks member then <a id="_ctl0_cphRoblox_HyperLink1" href="New.aspx">register</a>. It's easy and we do <em>not</em> share your personal information with anybody.</p>
    </div>
    <div id="PaneLogin">
      <h3>Log In</h3>
      <form method='post'>
  <tbody><tr>
    <td><table cellpadding="0" border="0">
      <tbody><tr>
        ...
        <td colspan="2" align="right"><input type="submit" herf="/home.php" name="Login" value="Log In"></td>
      </tr><tr>
...
<hr>
<p class="Legalese">
  QuantumBlocks, "Online Building Toy", characters, logos, names, and all related indicia are trademarks of <a id="_ctl0_rbxFooter_hlRobloxCorporation" href="/">ROBLOX Corporation</a>, 2007.  Patents pending.<br>
  Use of this site signifies your acceptance of the <a id="_ctl0_rbxFooter_hlTermsOfService" href="/">Terms and Conditions</a>.<br>
  <a id="_ctl0_rbxFooter_hlPrivacyPolicy" href="/">Privacy Policy</a> &nbsp;|&nbsp; <a href="/">Contact Us</a> &nbsp;|&nbsp; <a id="_ctl0_rbxFooter_hlAboutRoblox" href="/">About Us</a>
</p>
